#
#  Be sure to run `pod spec lint MOAFNetworking.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.version      = "0.0.1"
  s.summary      = "A short description of MOAFNetworking."
  s.homepage     = ‘https://github.com/yanghonglin/AFNetworking.git’
  ...
  s.author             = { "Henry Young” => “m@yanghonglin” }
...
s.subspec 'UIKit' do |ss|
  ...
  s.source       = { :git => "http://EXAMPLE/MOAFNetworking.git", :tag => "0.0.1" }
